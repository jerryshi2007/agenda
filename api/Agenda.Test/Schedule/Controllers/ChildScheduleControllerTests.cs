...
namespace Agenda.Test.Schedule.Controllers;
...
public class ChildScheduleControllerTests
{
    ...
    public async Task GetById_OthersSchedule_Returns403()
    {
        ...
        Assert.Equal("你只能查看或操作自己的日程", GetBodyProperty(status.Value, "Message"));
    }
    ...
    /// <summary>从错误体读取字段值（ObjectResult.Value 是 ErrorResponse）。</summary>
