// app/miniapp-test/__tests__/services/template.test.js
// 模板服务 API 封装测试
//
// 覆盖：6 个端点的 URL/method 映射、错误码错误信息映射（apply 防御性 message 补充）

jest.mock('../../../miniapp/services/api');

const api = require('../../../miniapp/services/api');
const template = require('../../../miniapp/services/template');
const { ErrorCodes, ErrorMessages } = require('../../../miniapp/contracts/template');
