// app/miniapp-test/__tests__/components/member-selector.test.js
...
const { UserRole } = require('../../../miniapp/contracts/schedule');
...
describe('member-selector 组件', () => {
  ...
  describe('WXML data-id 契约', () => {
    ...
    function readWxml() {
      return fs.readFileSync(path.resolve(__dirname, '../../../miniapp/components/member-selector/index.wxml'), 'utf8');
    }
