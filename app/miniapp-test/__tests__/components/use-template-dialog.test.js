// app/miniapp-test/__tests__/components/use-template-dialog.test.js
...
const { ErrorMessages } = require('../../../miniapp/contracts/template');
...
describe('use-template-dialog 组件', () => {
  ...
  describe('WXML data-id 契约', () => {
    ...
    function readWxml() {
      return fs.readFileSync(path.resolve(__dirname, '../../../miniapp/components/use-template-dialog/index.wxml'), 'utf8');
    }
