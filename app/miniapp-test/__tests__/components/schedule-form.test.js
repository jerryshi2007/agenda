// app/miniapp-test/__tests__/components/schedule-form.test.js
...
const { ScheduleType } = require('../../../miniapp/contracts/template');
...
describe('schedule-form 组件', () => {
  ...
  describe('WXML data-id 契约', () => {
    ...
    function readWxml() {
      return fs.readFileSync(path.resolve(__dirname, '../../../miniapp/components/schedule-form/index.wxml'), 'utf8');
    }
