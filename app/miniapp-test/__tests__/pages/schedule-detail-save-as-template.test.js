// app/miniapp-test/__tests__/pages/schedule-detail-save-as-template.test.js
...
jest.mock('../../../miniapp/services/template', () => mockTemplate);

const checkin = require('../../../miniapp/services/checkin');
const schedule = require('../../../miniapp/services/schedule');
const template = require('../../../miniapp/services/template');
const { CheckinStatus, Reason } = require('../../../miniapp/contracts/checkin');
...
describe('WXML data-id 契约', () => {
  ...
  function readWxml() {
    return fs.readFileSync(path.resolve(__dirname, '../../../miniapp/pages/schedule-detail/index.wxml'), 'utf8');
  }
