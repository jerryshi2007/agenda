// app/miniapp-test/__tests__/pages/child-month.test.js
...
const dateUtils = require('../../../miniapp/utils/date-utils');
  ...
  describe('错误态', () => {
    ...
    test('M5 回归：WXML 错误块显示固定文案"网络连接失败，请检查网络设置"', () => {
      ...
      const wxml = fs.readFileSync(
        path.resolve(__dirname, '../../../miniapp/pages/child-month/index.wxml'),
        'utf8'
      );
