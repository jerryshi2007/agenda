// app/miniapp-test/__tests__/pages/child-today.test.js
...
jest.mock('../../../miniapp/services/child-schedule', () => mockChildSchedule);
jest.mock('../../../miniapp/services/checkin', () => mockCheckin);

const childSchedule = require('../../../miniapp/services/child-schedule');
const checkinService = require('../../../miniapp/services/checkin');
const { DisplayMode } = require('../../../miniapp/contracts/family');
const { CheckinStatus } = require('../../../miniapp/contracts/checkin');
  ...
  describe('今日日程加载', () => {
    ...
    test('M5 回归：WXML 错误块显示固定文案"网络连接失败，请检查网络设置"', () => {
      ...
      const wxml = fs.readFileSync(
        path.resolve(__dirname, '../../../miniapp/pages/child-today/index.wxml'),
        'utf8'
      );
