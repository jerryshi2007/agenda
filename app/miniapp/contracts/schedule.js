...
const ErrorCodes = Object.freeze({
  ...
  HOMEWORK_NO_CANCEL: 'HOMEWORK_NO_CANCEL',
  NOT_CANCELLED_OR_EXCLUDED: 'NOT_CANCELLED_OR_EXCLUDED',
  SCHEDULE_TYPE_REQUIRED: 'SCHEDULE_TYPE_REQUIRED'
});
...
const ErrorMessages = Object.freeze({
  ...
  DATE_RANGE_TOO_LARGE: '日期范围过大，请缩小查询范围',
  SCHEDULE_ALREADY_CANCELLED: '该日程当天已取消',
  HOMEWORK_NO_CANCEL: '作业任务不支持取消',
  NOT_CANCELLED_OR_EXCLUDED: '该日程当天未被取消或排除',
  SCHEDULE_TYPE_REQUIRED: '日程类型不能为空'
});
...
const HttpStatus = Object.freeze({
  ...
  SCHEDULE_ALREADY_CANCELLED: 400,
  HOMEWORK_NO_CANCEL: 400,
  NOT_CANCELLED_OR_EXCLUDED: 400,
  SCHEDULE_TYPE_REQUIRED: 400
});
