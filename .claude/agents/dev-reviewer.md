...
2. **Read 对应 rules** — 审查 .NET 代码 → Read dev-dotnet-standards；审查 Vue 3 → Read dev-vue3-standards + design-ui-standards；另 Read dev-codegraph——用 `codegraph explore`（Bash）或 `codegraph_explore`（MCP）查被审改动的调用关系/影响面，替代 Read 大量上下文
