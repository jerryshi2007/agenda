...
|------|-------------------|---------------------|
| req-staging | req-brainstorming, req-review, test-case-design, test-e2e-playwright, staging-archive | req-analyst, req-reviewer, test-planner, archiver |
| openspec-workflow | arch-planning, dev-finishing-branch, dev-code-review, arch-design, arch-review, dev-sdd | arch-architect, arch-architect-reviewer, archiver |
| design-ui-standards | design-web, dev-vue3-tdd, arch-design, arch-review | ui-designer |
| ui-miniapp-standards | design-miniapp, dev-miniapp-tdd, arch-design, arch-review | ui-designer |
| dev-code-quality | arch-planning, dev-code-review, dev-refactoring, dev-dotnet-tdd, dev-vue3-tdd, dev-miniapp-tdd, arch-design, arch-review, dev-sdd | — |
| dev-contracts | arch-design, arch-review | arch-architect, arch-architect-reviewer, dev-dotnet, dev-miniapp, dev-vue3, test-writer |
| dev-codegraph | arch-design, arch-review, dev-sdd, dev-dotnet-tdd, dev-vue3-tdd, dev-miniapp-tdd | arch-architect, arch-architect-reviewer, test-planner, test-writer, test-reviewer, test-runner |
| dev-security | dev-debugging, dev-dotnet-tdd, dev-vue3-tdd, dev-miniapp-tdd, dev-code-review, arch-design, arch-review, dev-sdd | — |
...
| dev-miniapp-standards | dev-miniapp-tdd, arch-planning, arch-design, arch-review | dev-miniapp, test-planner |
...
> - **openspec-* 框架 skill**（openspec-propose/apply-change/archive-change/explore/sync-specs）与 `/opsx:*` 命令来自开源 openspec 框架，frontmatter 无 `rules:` 声明，其约束来自 `openspec/config.yaml` 的 `rules` 段——故不列入上表。
